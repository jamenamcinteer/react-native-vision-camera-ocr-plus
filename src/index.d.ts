export type { TextRecognizer, RecognizedText, TextBlock, TextLine, TextElement, BoundingFrame, CornerPoint, ScanRegion as NitroScanRegion, TextRecognitionConfig, } from './specs/TextRecognizer.nitro';
