...
open class HybridTranslatorSpec_cxx {
  ...
  // Methods
  @inline(__always)
  public final func translate(text: std.string, from: std.string, to: std.string) -> bridge.Result_std__shared_ptr_Promise_std__string___ {
    do {
      let __result = try self.__implementation.translate(text: String(text), from: String(from), to: String(to))
  ...
  @inline(__always)
  public final func removeLanguageModel(languageCode: std.string) -> bridge.Result_std__shared_ptr_Promise_bool___ {
    do {
      let __result = try self.__implementation.removeLanguageModel(languageCode: String(languageCode))
