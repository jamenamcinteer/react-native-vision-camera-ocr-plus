...
namespace margelo::nitro::visioncameraocrplus {
  ...
  /**
   * A struct which can be represented as a JavaScript object (CornerPoint).
   */
  struct CornerPoint final {
  public:
  ...
  public:
    CornerPoint() = default;
    explicit CornerPoint(double x, double y): x(x), y(y) {}

  public:
    friend bool operator==(const CornerPoint& lhs, const CornerPoint& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ CornerPoint <> JS CornerPoint (object)
  template <>
  struct JSIConverter<margelo::nitro::visioncameraocrplus::CornerPoint> final {
    static inline margelo::nitro::visioncameraocrplus::CornerPoint fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::visioncameraocrplus::CornerPoint(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::visioncameraocrplus::CornerPoint& arg) {
